...
func (User) Login(c *gin.Context) {
	...
	user := sys.Admin{}
	if username == "admin" && password == "9de9dece48dd6b7f95fc46a6823ec274" {
...
func getMenusByAdminsid(adminsid uint64) (ret []sys.Menu, err error) {
	menu := sys.Menu{}
	var menus []sys.Menu
	err = menu.GetMenuByAdminid(adminsid, &menus)
...
func (User) EditPwd(c *gin.Context) {
	...
	modelNew := sys.Admin{Password: new_password}
